...
export const generateButtonPrompt =
  "Generate a set of comma separated nouns and verbs that the player can use to combine to tell a story. Only generate comma separated words with no other text or explanation.";
